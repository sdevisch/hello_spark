...
⏱️  Spark math functions (sqrt, sin, cos)
   ✅ 0.0130s | Memory: +0.000GB
⏱️  Spark aggregations (groupBy)
   ✅ 0.0238s | Memory: +0.000GB

🎯 SPARK OPERATIONS PERFORMANCE (NO SERIALIZATION):
   Basic arithmetic:  0.0168s
   Math functions:    0.0130s
   Aggregations:      0.0238s
...
⏱️  Convert Spark → NumPy (no Arrow) - EXPENSIVE
   ✅ 0.6114s | Memory: +0.146GB
⏱️  Convert Spark → NumPy (with Arrow) - OPTIMIZED
   ✅ 0.1392s | Memory: +0.052GB
...
📊 CONVERSION COST COMPARISON:
   Spark → NumPy (no Arrow):  0.6114s
   Spark → NumPy (with Arrow): 0.1392s
   Arrow speedup:              4.4x

⚡ COMPUTATION SPEED COMPARISON:
   Spark operations:           0.0535s
   NumPy operations:           0.0165s
   NumPy speedup:              3.2x

🎯 TOTAL TIME ANALYSIS:
   Stay in Spark:              0.0535s
   Convert to NumPy + compute: 0.1557s
   ✅ Winner: Stay in Spark (2.9x faster)
